...
import './connect-with';
import UptappdConnectorImport from './untappd-connector-import-component';

class UptappdConnectorImportContainer extends Component {
  constructor(props) {
    super(props);
...
registerComponent(
  "UptappdConnectorImport",
  UptappdConnectorImportContainer,
  composeWithTracker(composer)
);

export default composeWithTracker(composer)(UptappdConnectorImportContainer);
