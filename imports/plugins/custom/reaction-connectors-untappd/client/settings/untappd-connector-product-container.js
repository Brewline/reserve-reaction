...
import UptappdConnectorProduct from './untappd-connector-product-component';

class UptappdConnectorProductContainer extends Component {
  constructor(props) {
    super(props);
...
registerComponent(
  "UptappdConnectorProduct",
  UptappdConnectorProductContainer,
  composeWithTracker(composer)
);

export default composeWithTracker(composer)(UptappdConnectorProductContainer);
